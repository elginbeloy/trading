...
training_bars = get_time_interval_bars(training_symbols, "day", "1", train_start_date, train_end_date)
eval_bars = get_time_interval_bars(eval_symbols, "day", "1", train_start_date, train_end_date)
